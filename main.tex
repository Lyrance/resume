...
Operating Systems Principles, Software Construction, Database Principles, Big Data Analysis, etc.
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item  \textbf{Networking:} Skilled in designing, deploying, and optimizing Azure network solutions across L4 and L7 layers, with expertise in troubleshooting and ensuring high performance, security, and reliability.
                \item \textbf{Security and Collaboration:} Experienced in resolving network protocol issues, implementing robust security measures, and working with cross-functional teams to enhance Azure services.
                \item \textbf{Customer Support:} Provided high-quality technical support to Premier/Unified-Enterprise customers in the APAC region, resolving high-priority Severity A cases efficiently in English and Mandarin.
                \item \textbf{Communication:} Effective in communicating with customers under pressure, quickly identifying key issues, and ensuring rapid restoration of network services.
            \end{highlights}
        \end{onecolentry}
        ...
        \section{Projects}
        \textit{\fontsize{7 pt}{7 pt}\selectfont *For better understanding, there are project demonstrations on \href{https://www.lyrance.com/}{my website(https://www.lyrance.com)}.}
        
        \begin{twocolentry}{
            \textit{Sept. 2024 - Mar. 2025}
            }
            \textbf{Leo Rover Exploration Vehicle}
        \end{twocolentry}
